...
class Scene4(internal val game: JoltSphereMain) : Screen {
    ...
    init {
        ...
        otherPlayer = MountainClimbingPlayer(world, 1600f, 200f, Color.BLUE)

    }

    private fun update(dt: Float) {
        streamBeam.input(Keys.UP, Keys.DOWN, Keys.LEFT, Keys.RIGHT, Keys.K, Keys.SEMICOLON, Keys.O)
        otherPlayer.input(Keys.W, Keys.S, Keys.A, Keys.D, Keys.SHIFT_LEFT, false)
    }
